...
class App(Tk):
    ...
    def _current_config(self) -> ProcessingConfig:
        ...
        return ProcessingConfig(
            ...
            max_concurrent_scrapes=self.config_data.max_concurrent_scrapes,
            scraper_headless=self.config_data.scraper_headless,
            scraper_proxy=self.config_data.scraper_proxy,
            external_scraper_dir=self.config_data.external_scraper_dir,
            external_scraper_command=self.config_data.external_scraper_command,
            external_scraper_timeout_seconds=self.config_data.external_scraper_timeout_seconds,
