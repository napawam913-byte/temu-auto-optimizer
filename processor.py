...
6. 保留原图用途。
7. 可以做明显但合理的视觉差异化，让图片更有 Temu 平台常见的热闹感、吸睛感和促销氛围，但不要让图片看起来像另一个商品。
8. 最终图片必须真实、自然、明亮、有点击欲，适合 Temu 商品轮播图使用。

允许的差异化优化：
1. 让背景更干净、更明亮、更丰富、更有电商氛围，同时保持原图画风一致。
2. 在适合的情况下，可以将背景或使用场景替换为相似真实 Temu 风格场景，例如明亮家居、厨房、浴室、收纳、户外、节日、礼品或生活方式场景。
3. 如果更换场景，必须贴近原图语境、商品品类、光线风格和 Temu 平台风格。
4. 可以适当增强光影方向、明暗层次、柔和阴影、边缘高光和局部反光，让商品更立体、更精致。
5. 可以在不改变商品结构和比例的前提下，轻微调整展示角度，让图片与普通竞品图形成差异。
6. 可以对画面进行适当放大或缩小，优化商品在 800x800 画布中的占比。
7. 可以优化构图、留白、视觉重心和背景层次，让画面更像 Temu 高点击率轮播图。
8. 可以适度提高亮度、饱和度、对比度、锐度和色彩活力，使图片更鲜明、更吸引人。
9. 可以加入自然的彩色背景、渐变光感、柔和光斑、干净桌面、生活化环境或轻微装饰氛围，但不能遮挡商品。
10. 减少压缩痕迹、噪点、灰尘、杂乱背景和廉价感。
11. 强化真实材质细节，例如纹理、缝线、边缘、厚度和表面质感。
12. 让图片整体更明亮、更饱满、更热闹、更适合 Temu 平台展示。

Temu 风格增强要求：
1. 画面可以比原图更丰富、更鲜亮、更有促销感，但必须保持真实商品不变。
2. 优先使用明亮、干净、高饱和但不刺眼的色彩，让商品更突出。
3. 可以营造轻微的“爆款电商图”氛围，例如更强的光线、更鲜明的背景、更清晰的主体边缘和更强的视觉冲击。
4. 背景可以更有层次和生活感，不必过度极简；但不要添加文字、价格、徽章、贴纸、图标或水印。
5. 商品主体必须仍然是画面中心，任何花哨效果都只能服务于突出商品。
